...
.data-type-item, .example, .exercise, .code-example { /* Incluyo .code-example para aplicar los estilos */
...
.data-type-item h4, .example h4, .exercise h4, .code-example h4 {
  color: #007bff;
  margin-bottom: 10px;
}

.data-type-item pre, .example pre, .exercise pre, .code-example pre {
...
.data-type-item button, .example button, .exercise button, .code-example button {
...
.data-type-item button:hover, .example button:hover, .exercise button:hover, .code-example button:hover {
